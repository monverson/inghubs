...
public class Constant {
    ...
    public static final String INSUFFICIENT_FUNDS_FOR_BUY_ORDER = "Insufficient funds for BUY order";
    public static final String ORDER_NOT_FOUND = "Order not found";
    public static final String PENDING_STATUS_CAN_BE_DELETED = "Only Pending status can be deleted";
